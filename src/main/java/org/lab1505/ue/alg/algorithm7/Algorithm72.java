...
public class Algorithm72 {
    ...
    public static double computeMarginalCost(double length,double density){
        double A = 7.46858*density*Math.pow(length,2);
        double B = Math.pow(101.195-density, 2)*1760;
        return A/B;
    }
    ...
    public static double computeTraveltime(double length,double density){
        return (3600.0/1760)*(length/(27.71485-0.2738748*density));
    }
    ...
    public static void run(String netUrl,String tripUrl,String volumeUrl){
        try {
            ...
            while(n<6){
                ...
                CsvGraphWriter.writeTo(net, NetEdge.class, FileDirectoryGenerator.createFileAutoRename("a7_2_net", "csv"));
                CsvGraphWriter.writeTo(trip, TripEdge.class, FileDirectoryGenerator.createFileAutoRename("a7_2_trip", "csv"));
                n ++;
            }
